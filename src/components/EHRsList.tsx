...
const EHRsList = () => {
  ...
  const ehrs: EHRProps[] = [
    ...
    { name: "Athenahealth", logo: "/lovable-uploads/1c5472d7-e4f4-4600-aaeb-caf82e38a788.png" },
    ...
    { name: "drchrono", logo: "/lovable-uploads/a78a5799-5c61-418b-9c7e-2dcc54f3a992.png" },
